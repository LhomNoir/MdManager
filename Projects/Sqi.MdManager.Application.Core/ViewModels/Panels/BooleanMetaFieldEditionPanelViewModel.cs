...
{
    public class BooleanMetaFieldEditionPanelViewModel : MetaFieldEditionPanelViewModel<IBooleanMetaField>
    {
        #region Properties
        ...
        public static BooleanMetaFieldEditionPanelViewModel Create()
        {
            return ViewModelSource.Create(() => new BooleanMetaFieldEditionPanelViewModel());
        }
