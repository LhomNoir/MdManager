...
{
    public class IntegerMetaFieldTemplateEditionPanelViewModel : MetaFieldEditionPanelViewModel<IIntegerMetaField>
    {
        #region Properties
        ...
        public static IntegerMetaFieldTemplateEditionPanelViewModel Create()
        {
            return ViewModelSource.Create(() => new IntegerMetaFieldTemplateEditionPanelViewModel());
        }
