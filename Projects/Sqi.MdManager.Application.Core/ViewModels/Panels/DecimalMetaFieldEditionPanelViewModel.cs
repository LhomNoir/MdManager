...
{
    public class DecimalMetaFieldEditionPanelViewModel : MetaFieldEditionPanelViewModel<IDecimalMetaField>
    {
        #region Properties
        ...
        public static DecimalMetaFieldEditionPanelViewModel Create()
        {
            return ViewModelSource.Create(() => new DecimalMetaFieldEditionPanelViewModel());
        }
