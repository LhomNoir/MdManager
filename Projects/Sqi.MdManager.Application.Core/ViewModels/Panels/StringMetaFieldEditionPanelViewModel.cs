...
{
    public class StringMetaFieldEditionPanelViewModel : MetaFieldEditionPanelViewModel<IStringMetaField>
    {
        #region Properties
        ...
        public virtual MetaEntityItemViewModel MetaEntityItemViewModel { get; protected set; }
        public virtual EntityFieldItemViewModel MetaEntityFieldItemViewModel { get; protected set; }
        #endregion

        #region Methods

        public static StringMetaFieldEditionPanelViewModel Create()
        {
            return ViewModelSource.Create(() => new StringMetaFieldEditionPanelViewModel());
        }
        ...
        protected override void InitializeFieldValidators(IStringMetaField metaField)
        {
            ...
            MetaEntityFieldItemViewModel = EntityFieldItemViewModel.Create(fieldValidator, Entity, metaEntities, metaField.MetaEntity);
