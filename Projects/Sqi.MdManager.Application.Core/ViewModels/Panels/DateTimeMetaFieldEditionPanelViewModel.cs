...
{
    public class DateTimeMetaFieldEditionPanelViewModel : MetaFieldEditionPanelViewModel<IDateTimeMetaField>
    {
        #region Properties
        ...
        public static DateTimeMetaFieldEditionPanelViewModel Create()
        {
            return ViewModelSource.Create(() => new DateTimeMetaFieldEditionPanelViewModel());
        }
